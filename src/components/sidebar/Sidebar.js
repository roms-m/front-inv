import './sidebar.css';
import { LineStyle, Timeline, TrendingUp, Person, Storefront, AttachMoney, Mail, DynamicFeed, ChatBubbleOutline, CardTravel, Report } from '@material-ui/icons';
        ...
        <div className="sidebar">
            <div className="sidebarWrapper">
                ...
                <div className="sidebarMenu">
                    ...
                    <ul className="sidebarList">
                        ...
                        <Link to="/products" className="link">
                            <li className="sidebarListItem">
                                <Storefront className="sidebarIcon" /> Producs
                            </li>
                        </Link>
                        <li className="sidebarListItem">
                ...
                <div className="sidebarMenu">
                    ...
                    <ul className="sidebarList">
                        <li className="sidebarListItem">
                            <CardTravel className="sidebarIcon" /> Manage
                        </li>
                        <li className="sidebarListItem">
                            <Timeline className="sidebarIcon" /> Analytics
                        </li>
